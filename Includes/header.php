...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Cambridge University India Society</title>
...
<script type="text/javascript" src="/Scripts/fancybox/source/helpers/jquery.fancybox-thumbs.js?v=1.0.7"></script>
        ...
        <link href="Styles/bgstretcher.css" rel="stylesheet" type="text/css" />
		...
		<meta name="keywords" content="Cambridge, India, society, student, indiasoc">
		<meta name="description" content=".">
		<meta http-equiv="content-type" content="text/html;charset=UTF-8">
    </head>
    <body background="Images/bluepaisley (copy).jpg">
        <div id="page">
            <div id="header"><div style="text-align: center"><a id="logo" href="/">
                <img alt="Cambridge University India Society" src="../Images/Common/logo.png"/>
            </a></div>

</head> <div id="menubar">
<ul>                      
                    <li></li> <li></li> <li></li> <li></li> <li></li> <li></li>  <li><a href="/index.php">Home</a></li>
